...
export class SMenuComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.fetch1.subject2.subscribe((data: any)=>{
      this.o=data
    })

    this.fetch1.subject3.subscribe((data: any)=>{
      this.d=data
    })

    this.fetch1.subject4.subscribe((data: any)=>{
      this.le=data
    })

    this.fetch1.subject5.subscribe((data: any)=>{
      this.he=data
    })

    this.fetch1.subject6.subscribe((data: any)=>{
      this.d_flag=data
    })
